...
if __name__ == "__main__":
    ...
    cull_scan(scan, ply_file, result_mesh_file, instance_dir=args.mask_dir)

    cmd = f"python dtu_eval/eval.py --data {result_mesh_file} --scan {scan} --mode mesh --dataset_dir {Offical_DTU_Dataset} --vis_out_dir {out_dir}"
    os.system(cmd)