...
from convert_data_to_json import export_to_json2  # NOQA
...
def init_colmap(tnt_path):
    assert tnt_path, "Provide path to Tanks and Temples dataset"
    scene_list = os.listdir(tnt_path)
    ...
    for scene in scene_list:
        ...
        export_to_json2(bounding_box, list(center), radius, os.path.join(scene_path, 'bounding.json'))
        print('Writing data to json file: ', os.path.join(scene_path, 'bounding.json'))




init_colmap('../../data/TNT_GOF/TNT_real/')
